...
class Request(Base):
    ...
    # ---- #
    service_unit: "Link[ServiceUnit]" = Field(..., description="Yêu cầu cho dịch vụ")  # type: ignore  # noqa: F821
    area: "Link[Area]" = Field(..., description="Yêu cầu cho khu vực")  # type: ignore  # noqa: F821
    branch: "Link[Branch]" = Field(..., description="Yêu cầu cho chinh nhánh")  # type: ignore  # noqa: F821
    business: "Link[Business]" = Field(..., description="Yêu cầu cho doanh nghiệp")  # type: ignore  # noqa: F821
